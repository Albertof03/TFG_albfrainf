<script>
  ...
  import { loadCSVData, initMap, createHeatMap, createEarthquakeCountHeatMap, loadTectonicPlates, drawTectonicPlates, removeHeatMap, removeTectonicPlates } from "../../../backend/heatmap.js";
  import { location } from "svelte-spa-router";
  import Menu from "./routes/menu.svelte";
  import Perfil from "./routes/perfil.svelte";
  import Register from "./routes/register.svelte";
  import Login from "./routes/login.svelte";
  import Alerta from "../src/routes/alerta.svelte";  // Importa Alerta
  ...
  // Función para actualizar el heatmap en tiempo real
