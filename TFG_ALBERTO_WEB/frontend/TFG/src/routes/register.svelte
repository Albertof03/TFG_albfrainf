<script>
  ...
  async function register() {
    try {
      await axios.post("https://tfgalbertoweb-production.up.railway.app/register", {
...
/* Añadir margen entre los campos de entrada */
.input-field {
  margin-bottom: 15px; /* Espacio entre las cajas de entrada */
}
