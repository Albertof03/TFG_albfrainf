...
const dispatch = createEventDispatcher();  // Evento para comunicar cambios de fecha
...
const updateDate = (event) => {
    ...
    dispatch("dateChange", { date: selectedDate });  // Emitir evento cuando cambia la fecha
  };
...
<style>
  .slider-container {
    ...
    input[type="range"] {
      width: 90%; /* Hace la barra más larga */
